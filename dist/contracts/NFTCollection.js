...
class NftCollecion {
    ...
    createDataCell() {
        ...
        const collectionContent = (0, utils_1.encodeOffChainContent)(this.collectionData.collectionContentUrl);
    ...
    toUpBalance(walletData, nftAmount) {
        return __awaiter(this, void 0, void 0, function* () {
